...
_REGISTRY = {
    ...
    "cricket": {
        ...
        "get_game_summary": {"required": ["event_id"], "optional": ["series_id"]},
    ...
    "cfb": {
        ...
        "get_team_stats": {"required": ["team_id"], "optional": ["season_year", "season_type"]},
        "get_player_stats": {"required": ["player_id"], "optional": ["season_year", "season_type"]},
        "get_ncaa_scoreboard": {"required": ["week"], "optional": ["division", "season"]},
        "get_ncaa_schedule": {"optional": ["division", "season"]},
        "get_ncaa_game": {"required": ["game_id"]},
        "get_ncaa_boxscore": {"required": ["game_id"]},
        "get_ncaa_play_by_play": {"required": ["game_id"], "optional": ["limit"]},
        "get_ncaa_scoring_summary": {"required": ["game_id"]},
    ...
    "cbb": {
        ...
        "get_ncaa_scoreboard": {"required": ["date"], "optional": ["division"]},
        "get_ncaa_schedule": {"required": ["month"], "optional": ["division", "season"]},
        "get_ncaa_game": {"required": ["game_id"]},
        "get_ncaa_boxscore": {"required": ["game_id"]},
        "get_ncaa_play_by_play": {"required": ["game_id"], "optional": ["limit"]},
        "get_ncaa_bracket": {"optional": ["year", "division"]},
        "get_ncaa_schools": {"optional": ["query"]},
    },
    "golf": {
